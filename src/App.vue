          ...
          <nav class="site-navigator">
            <span class="logo">
              <svg height="1.2em" viewBox="0 0 168 168" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M128.176 61.5087C142.491 61.5087 154 49.9999 154 35.7543C154 21.5087 142.421 10 128.176 10C113.86 10 102.351 21.5087 102.351 35.7543C102.351 49.9999 113.86 61.5087 128.176 61.5087Z" fill="#FFFFFF"></path><path d="M39.8248 149.368C54.1406 149.368 65.6493 137.859 65.6493 123.614C65.6493 109.368 54.0704 97.8594 39.8248 97.8594C25.5091 97.8594 14.0003 109.368 14.0003 123.614C13.9301 137.859 25.5091 149.368 39.8248 149.368Z" fill="#FFFFFF"></path><path d="M109.86 17.5789C85.369 7.47363 56.1059 12.3157 36.1761 32.1052C16.2463 51.9648 11.4042 81.0173 21.5095 105.438L109.86 17.5789Z" fill="#FFFFFF"></path>
                <path d="M58.0713 141.859C82.5625 151.965 111.826 147.123 131.755 127.333C151.685 107.473 156.527 78.4209 146.422 53.9999L58.0713 141.859Z" fill="#FFFFFF"></path></svg>
            </span>
            ...
            <div class="styles__StyledLink-sc-syqzwc-0 jDyAjk">
              <a target="_blank" href="https://console.aleph.im/">
                <div class="styles__StyledRouterLink-sc-11bcwqi-1 fnIBfA  tp-nav">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 502 512" theme="[object Object]" class="cmp__StyledCustomIcon-sc-9v58yf-0 htIPLr styles__StyledRouteLinkIcon-sc-11bcwqi-2 ioOCuj"><path d="M246.9 60.3a194.5 194.5 0 1 0 0 388.9 194.5 194.5 0 1 0 0-388.9zM158.5 303.5c-3 3-7.1 4.6-11.1 4.6s-8-1.6-11.1-4.6c-6.2-6.2-6.2-16.1 0-22.2l11.1-11.1 19-19-19-19-11.1-11.1c-6.2-6.2-6.2-16.1 0-22.2c6.1-6.2 16.1-6.2 22.2 0l41.2 41.2c2.9 2.9 4.6 6.9 4.6 11.1s-1.7 8.2-4.6 11.1l-41.2 41.2zm187.8 11.6H218c-8.7 0-15.7-7-15.7-15.7s7-15.7 15.7-15.7H346.3c8.7 0 15.7 7 15.7 15.7s-7 15.7-15.7 15.7z"></path></svg>
                </div>
              </a>
            </div>
            <div class="active">
            ...
            <div class="styles__StyledLink-sc-syqzwc-0 jDyAjk">
              <a target="_blank" href="https://swap.aleph.im/">
                <div class="styles__StyledRouterLink-sc-11bcwqi-1 fnIBfA  tp-nav">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 365 512" theme="[object Object]" class="cmp__StyledCustomIcon-sc-9v58yf-0 htIPLr styles__StyledRouteLinkIcon-sc-11bcwqi-2 ioOCuj"><path d="M257.3 189.4l64.9 37.7V183.9l-70.5-41-127.2 74v43.2l121.5-70.5c3.5-2 7.9-2 11.4 0v-.1zM101.5 260V216.7l-9.2-5.3L52.5 188.3l-11.3-6.6-11.4-6.6L4 160.1v30 13.2l70.4 41L101.5 260zM71.3 81.5l1.4-.8L94 68.3l14.6-8.4L75 40.3 60.6 32V69.9v5.3l9.7 5.6 1 .7zm-7.5 87l11.4 6.6 37.8 22 132.9-77.3c3.5-2 7.9-2 11.4 0l67.6 39.3 9.1-57.9 3.4-21.4 1.8-11.5L341 56.8l7.4-47.1L88.5 21.6 137 49.8c3.5 2 5.7 5.8 5.7 9.8c0 2.3-.8 4.4-2 6.4c-.9 1.4-2.2 2.6-3.6 3.5l-5.7 3.3L122 78.3l-2 1.1L100.7 90.6l-6.6 3.8-11.4 6.6-11.4 6.6L15.2 140.1l37.2 21.6 11.4 6.6v.2zM335.2 343l-11.4 6.6-11.3 6.5-15.4 9-40.7 23.7 37.2 21.6 15.2-8.9L361 371.2v-.1V358.1 328l-25.8 15zM228 378.9l61.8-36 11.4-6.6 11.4-6.6 37.2-21.6-97.6-56.7L119.2 328.7c-3.5 2-7.9 2-11.4 0L40.3 289.4l-6.4 40.3-1.8 11.4L16.7 438.7l11-.5 194.7-9 11.4-.6 11.4-.6 19.2-.9 12.2-.6-5.6-3.3-25.8-15-11.4-6.6-5.7-3.3c-3.5-2-5.7-5.8-5.7-9.8s2.2-7.9 5.7-9.8H228zm43 70.9l-24.6 1.1-12.6 .7-9.2 .3h-.2l-1.9 .1L24.1 461.1l-9.4 .5v46.8l282.9-13 6.8-.3v-8.9V448.3L271 449.8z"></path>
                  </svg>
                </div>
              </a>
            </div>
